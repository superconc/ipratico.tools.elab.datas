...
public class NegozioConfigEntity {
    ...
    @Column(name = "ID_NEGOZIO_CONFIG")
    private Long idNegozioConfig;
    ...
    // Getters e setters
    public Long getIdNegozioConfig() {
        return idNegozioConfig;
    }

    public void setIdNegozioConfig(Long idNegozioConfig) {
        this.idNegozioConfig = idNegozioConfig;
    }
